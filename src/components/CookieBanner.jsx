...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[60] p-4 sm:p-6 bg-dark-card border-t border-white/10 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
