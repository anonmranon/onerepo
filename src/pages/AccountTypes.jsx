...
const ACCOUNTS = [
  ...
  },
  {
    ...
    cta: 'OPEN STANDARD',
    to: '/create-account',
    description: 'Our most popular account — competitive conditions with no commission. Ideal for new live traders.',
  },
  {
    type: 'Gold',
    icon: '🥇',
  ...
  },
  {
    ...
    cta: 'OPEN ECN',
    to: '/create-account',
    description: 'Institutional-grade, raw commission-based pricing with direct market access. For serious professionals and scalpers.',
  },
];
